...
function openChatWindow(context) {
    return __awaiter(this, void 0, void 0, function () {
        var apiKey, panel;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    apiKey = (0, QbraidAPI_1.getQbraidAPIKey)();
                    if (!apiKey) {
                        vscode.window.showErrorMessage('API Key is missing or invalid!');
                        return [2 /*return*/];
                    }
                    return [4 /*yield*/, (0, ChatUI_1.createChatPanel)(context)];
                case 1:
                    panel = _a.sent();
                    panel.webview.postMessage({ type: 'setApiKey', apiKey: apiKey });
                    return [2 /*return*/];
            }
        });
    });
